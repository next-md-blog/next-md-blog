...
description: Build a multilingual (i18n) Markdown blog in Next.js — locale subfolders, getInAllLocales, and locale-aware metadata and sitemap with @next-md-blog/core.
---
