...
Use these as references for **`locale`** on `collection.getOne` / `collection.getAll` and for routing structure alongside [Internationalization](/internationalization).
