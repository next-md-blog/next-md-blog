...
describe('index.ts exports', () => {
  ...
  it('should export getBlogSitemap and getBlogRobots', async () => {
    ...
    expect(typeof module.getBlogSitemap).toBe('function');
    expect(typeof module.getBlogRobots).toBe('function');
  });

  it('should export generateOrganizationSchema', async () => {
    const module = await import('../index.js');
    expect(module.generateOrganizationSchema).toBeDefined();
    expect(typeof module.generateOrganizationSchema).toBe('function');
  });
